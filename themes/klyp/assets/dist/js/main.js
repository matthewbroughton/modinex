...
$(document).ready(function() {
  ...
  $('#openMenuButton').on('click', function (e) {
    ...
    $('#mobileMenu').toggleClass('-translate-y-full');
  });
  ...
  $('.mn-header__search-box').on('keyup', function(e) {
      ...
      searchTimer = setTimeout(function() {
          ...
          <li class="leading-tight mb-2 section-product__sidebar-filter-content-list-item list-inline-item previous_search_saved">\
            <a href="#" class="flex items-center gap-2 previous_search">\
...
$(document).ready(function() {
  ...
  // init accordions
  const accordions = document.querySelectorAll('.accordion .accordion-trigger');
...
$(document).ready(function() {
  ...
  $('.product-option').click(function() {
    ...
    if ($(this).hasClass('active')) {
      ...
      if (! $(this).hasClass('option-disabled')) {
        $(this).parents('.product-options-list').children('.product-option').removeClass('active');
        $(this).addClass('active');
      }
    }
    ...
    if (next_section.length && ! $(this).hasClass('option-disabled')) {
      $(this).parent().parent().nextAll().find('.product-options-list').children('.product-option').removeClass('active');
      if (noSelect) {
        $(this).parent().parent().nextAll().find('.product-options-list').children('.product-option').addClass('option-disabled');
      } else {
        $(this).parent().parent().next().nextAll().find('.product-options-list').children('.product-option').addClass('option-disabled');
        $('html,body').animate({
  ...
  $('.section-project-bottom-nav__btn-form').on('click', function (e) {
    ...
    let html = '';
    options = {};
    $('.product-options-list').each(function() {
      let optionHtml = '';
      let hasActive = 0;
      $(this).find('.product-option').each(function() {
        if (! $(this).hasClass('option-disabled')) {
          let option_value = $(this).find('.product-option-title').text();
          if ($(this).hasClass('active')) {
            hasActive = 1;
      ...
      if (hasActive) {
        let option_type = $(this).find('.product-option.active').parent().parent().data('option-type');
        let option_value = $(this).find('.product-option.active').text();
  ...
  function price_update()
  {
    ...
    $('.product-option.active').each(function() {
    ...
    if ($(this).is(':checked')) {
      ...
      if ($.inArray(option_value,all_selected_filter) == -1) {
        $('.section-product__sidebar-filter-content-list').append('\
          <li class="leading-tight mb-2 section-product__sidebar-filter-content-list-item fo_' + option_value + '">\
              <a href="javascript:void(0);" class="flex items-start gap-2 product-remove-cat group" data-id="' + option_value + '">\
  ...
  function show_email_specs_on_load(nextType, opKey, callAjax, callType) {
    ...
    $('.product-option').each(function() {
      ...
      var option_value = $(this).find('.product-option-title').text();
      ...
      if ($(this).hasClass('active')) {
        ...
        //Update value if exists, or append new value
        html += '<div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0' + row_class + '">\
          <dt class="ot_title capitalize">' + option_type + '</dt>\
          <dd class="ot_value mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">' + option_value + '</dd>\
        </div>';
        options[row_class] = option_type + ': ' + option_value.trim() + '\n';

<?php
//Settings
$section_show = get_field('projects_mini_projects_lists')['enable_component'];
$section_id = get_field('projects_mini_projects_lists')['id'];
$section_class = get_field('projects_mini_projects_lists')['class'];
$section_layout = get_field('projects_mini_projects_lists')['component_mini_projects_lists_layout_switch'];
...
//true means using default layout( showing the latest 3 projects)
if ($section_layout) {
    ...
    $feature_projects_list = get_field('projects_mini_projects_lists')['component_mini_projects_lists'];
